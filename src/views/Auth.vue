				...
				<v-col cols="12" sm="6">
					<v-row justify="center">
						<v-col
							...
							md="4"
							lg="3"
							class="text-center text-h3 primary--text font-weight-bold"
						>
							BODEGA
						</v-col>
						<v-col
					...
					<v-row justify="center" class="text-center">
						<v-col cols="12" sm="10" lg="8">
							...
							<div class="mt-4 mb-2 subtitle-1 font-weight-bold secondary--text">
								<small v-if="step == 1"> ¿No eres parte de bodega? </small>
								<small v-else>¿Ya tienes cuenta en bodega?</small>
							</div>
							...
							<div class="font-weight-bold caption secondary--text">2021 Bodega</div>
						</v-col>
					</v-row>
				</v-col>
